...
For private disclosure, use GitHub Security Advisories: [https://github.com/gr8monk3ys/cocoon/security/advisories](https://github.com/gr8monk3ys/cocoon/security/advisories).
